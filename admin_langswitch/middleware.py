...
class CustomMultilingualURLMiddleware(parent):
    ...
    This class is EXPERIMENTAL although working successfully in production
    environment.
    Please take  a moment to examine/adapt the code, to make sure it does what
    you need.
    """
    ...
    def process_response(self, request, response):
        if self.is_cms(request):
            return super(CustomMultilingualURLMiddleware,
